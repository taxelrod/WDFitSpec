...
;
;  $Id: mpfit.pro,v 1.1.1.1 2008/07/29 09:38:53 prugniel Exp $
;-
...
pro mpfit_dummy
  ...
  FORWARD_FUNCTION mpfit_fdjac2, mpfit_enorm, mpfit_lmpar, mpfit_covar, mpfit, mpfit_call
  
; The next commented statement has been replaced by the above, because
; it crashs GDL !!
...
;    mpfit, mpfit_call
  ...
  error_code = 0 ;; without this init CGL comp crashes (PhP)
  ...
  mpconfig = {fastnorm: 0, proc: 0, nfev: 0L, damp: 0} ;; init (PhP)
end
